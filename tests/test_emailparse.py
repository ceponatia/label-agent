...
POSHMARK_ORDER = "7c4e91a3f086d2b5c9e01f47"
...
VINTED_ATTACHMENT = "Vinted-Label-58412906634.pdf"
...
def test_parse_poshmark_direct():
    ...
    assert c.subject == f'"{POSHMARK_ITEM}" just sold to @samplebuyer42 on Poshmark!'
...
def test_forwarded_keeps_attachment_and_quotes_original_headers():
    ...
    assert posh.from_addr == "jordan.sells99@example.com"
    ...
    assert vinted.from_addr == "jordan.sells99@example.com"
...
def test_tracking_tolerates_embedded_spaces():
    assert extract_tracking("Tracking Number 9405 5096 9993 8843 0012 34") == (
        POSHMARK_TRACKING
    )
